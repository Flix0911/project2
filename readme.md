...
- Started working on media styling now as well. I wonder with this, what is the point? I hate browsing anything using my phone unless it is a quick lookup and even still, that is always a terrible experience. This is the most interesting part, the phone!

| 1/18 Below tasks accomplished |
- More styling!
- Played around with the finer details of some colors, hovers, buttons, and such
- Media is up and completely functional minus 1 problem I am having. Owned and Wanted index pages sees the h1 not displaying correctly. I fixed all other media problems like checkbox, buttons in odd spots, an other little details, but this one persists. I was able to get it displayed on all other pages, dev tools are extremely useful, but still not seeing the change I need. Going to return to this later today
- Cleaned up my css file a bit and combined portions here and there for easier legibility

| Overall thought |
- I never did get to Auth. I'm disappointed by that but can certainly add that at another time for displaying in a portfolio. I still think the application looks somewhat flat but I think some of the colors blend a little bit better. There are bits and pieces that stand out to you a lot more now